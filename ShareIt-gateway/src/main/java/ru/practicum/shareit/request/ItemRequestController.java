...
public class ItemRequestController {
    ...
    @GetMapping
    public ResponseEntity<Object> getAllRequestsByOwnerId(@RequestHeader("X-Sharer-User-Id") Long ownerId) {
        log.info("Get all owner requests with ownerId = {}", ownerId);
        return requestClient.getAllRequestsByOwnerId(ownerId);
    }

    @PostMapping
    public ResponseEntity<Object> createItemRequest(@RequestHeader("X-Sharer-User-Id") Long ownerId,
